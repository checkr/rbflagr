...
rbflagr - the Ruby client gem for the Flagr
...
### Install from Git
    ...
    gem 'rbflagr', :git => 'https://github.com/checkr/rbflagr.git'
...
All URIs are relative to *http://localhost:port/api/v1*
...
## Documentation for Authorization
 ...
 All endpoints do not require authorization. It's designed to be a microservice used in an internal network.
