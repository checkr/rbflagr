...
module Flagr
  ...
  class Constraint
    ...
    def list_invalid_properties
      ...
      if @property.to_s.length < 1
        invalid_properties.push("invalid value for 'property', the character length must be great than or equal to 1.")
      end
    ...
    def valid?
      ...
      return false if @property.to_s.length < 1
      return false if @operator.nil?
      operator_validator = EnumAttributeValidator.new('String', ["EQ", "NEQ", "LT", "LTE", "GT", "GTE", "EREG", "NEREG", "IN", "NOTIN", "CONTAINS", "NOTCONTAINS"])
    ...
    def property=(property)
      ...
      if property.to_s.length < 1
        fail ArgumentError, "invalid value for 'property', the character length must be great than or equal to 1."
      end
    ...
    def operator=(operator)
      validator = EnumAttributeValidator.new('String', ["EQ", "NEQ", "LT", "LTE", "GT", "GTE", "EREG", "NEREG", "IN", "NOTIN", "CONTAINS", "NOTCONTAINS"])
    ...
    def hash
      [id, property, operator, value].hash
    end
